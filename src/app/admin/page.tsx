  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-sm">
        <Link href="/" className="text-slate-800 hover:text-slate-900 text-sm mb-4 inline-flex items-center font-medium min-h-[44px] py-2">
          ← Home
        </Link>
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden text-slate-900">
          ...
          <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-xl bg-slate-800 px-4 py-3 text-white font-medium hover:bg-slate-700 disabled:opacity-50 transition min-h-[48px]"
            >
